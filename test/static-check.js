...
assert.match(detector, /FALLBACK_MODEL_METADATA_WAIT_WINDOW_MS = 6000/);
...
assert.match(content, /FALLBACK_MODEL_METADATA_WAIT_WINDOW_MS = 6000/);
...
assert.match(readme, /当前版本：`1\.1\.3`/);
assert.match(readme, /1\.1\.3/);
assert.match(readme, /54 项行为测试/);
